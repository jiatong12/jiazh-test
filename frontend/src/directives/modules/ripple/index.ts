...
const ripples = {
  show(e: PointerEvent, el: CustomHTMLElement, value: RippleOptions = {}) {
  ...
  hide(el: CustomHTMLElement | null) {
...
function rippleShow(e: PointerEvent) {
  ...
  const element = e.currentTarget as CustomHTMLElement | undefined
...
function rippleHide(e: Event) {
  const element = e.currentTarget as CustomHTMLElement | null
...
function updateRipple(
  ...
  if (enabled && !wasEnabled) {
    ...
    el.addEventListener('pointerout', rippleHide)
  }
...
function removeListeners(el: HTMLElement) {
  ...
  el.removeEventListener('pointerout', rippleHide)
}

function mounted(el: CustomHTMLElement, binding: RippleDirectiveBinding) {
  updateRipple(el, binding, false)
}

function unmounted(el: CustomHTMLElement) {
  delete el._ripple
  removeListeners(el)
}

function updated(el: CustomHTMLElement, binding: RippleDirectiveBinding) {
